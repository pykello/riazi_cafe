\begin{problem}{/images/problems/24_dices.jpg}{Boxes and Dice}
...
\begin{center}
	\includegraphics[width=12cm]{/images/problems/sol1.png}
\end{center}
...
\begin{center}
	\includegraphics[width=12cm]{/images/problems/sol2.png}
\end{center}
