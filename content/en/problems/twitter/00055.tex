\begin{problem}{/images/problems/55_pic.png}{Maximum Number of Edges}  What is the maximum number of edges of a simple graph with 100 vertices that has no cycle of even length?
\end{problem}
