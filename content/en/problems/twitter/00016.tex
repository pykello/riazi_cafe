\begin{problem}{/images/problems/pic.jpg}{Finding the Area}In the figure below, the length of each side of the square is 8cm. Find the area of the green part.

\begin{center}
	\includegraphics[width=8cm]{/images/problems/16_geometry1.jpg}
\end{center}
...
\begin{center}
	\includegraphics[width=14cm]{/images/problems/16_geometry2.jpg}
\end{center}
